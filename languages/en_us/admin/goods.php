 ...
 * ----------------------------------------------------------------------------
 * This is a free/open source software£ªit mean that you can modify, use and
...
$_LANG['js_languages']['go_category_page'] = "This page's data will lost, are you sure to go to adding category page£ø";
$_LANG['js_languages']['go_brand_page'] = "This page's data will lost, are you sure to go to adding brand page£ø";
