...
<tr>
<td><?php echo $lang['ucenter_not_match'];
    ?></td>
</tr>
</table>
<?php 
...
<table border="0" cellpadding="0" cellspacing="0" class="uc_table">
<tr>
<td><?php echo $lang['ucenter_no_database'];
    ?></td>
</tr>
</table>
<?php 
...
<td valign="top">
<div id="wrapper">
  <h3><?php echo $lang['users_importto_ucenter'];
    ?></h3>

<table width="550" class="list">
<tr>
    <td colspan="2"><?php printf($lang['user_startid_intro'], $maxuid, $maxuid);
    ?></td>
</tr>
<tr>
    <td width="125" align="left"><?php echo $lang['user_merge_method'];
    ?></td>
    <td align="left"><input type="radio" name="js-merge" id="js-merge-1" value="1" checked="true" /><label for="js-merge-1"><?php echo $lang['user_merge_method_1'];
    ?></label><br /><input name="js-merge" type="radio" value="2" id="js-merge-2" /><label for="js-merge-2"><?php echo $lang['user_merge_method_2'];
    ?></label>
...
<td width="227" valign="top" background="images/install-step3-<?php echo $installer_lang;
    ?>.gif">&nbsp;</td>
</tr>
<tr>
  <td>
  ...
  <input type="button" class="button" id="js-pre-step" class="button" value="<?php echo $lang['prev_step'];
    ?>" />
  <input id="js-submit-uc" type="button" class="button" value="<?php echo $lang['next_step'];
    ?><?php echo $lang['ucenter_import_members'];
    ?>" />
</div>
  </td><td></td>
</tr>
